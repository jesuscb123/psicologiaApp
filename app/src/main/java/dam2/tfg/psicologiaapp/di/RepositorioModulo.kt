...
import dam2.tfg.psicologiaapp.notificaciones.data.repository.AlertaRiesgoRepositoryImpl
...
abstract class RepositorioModulo {
    ...
    @Binds
    @Singleton
    abstract fun bindAlertaRiesgoRepository(
        impl: AlertaRiesgoRepositoryImpl,
