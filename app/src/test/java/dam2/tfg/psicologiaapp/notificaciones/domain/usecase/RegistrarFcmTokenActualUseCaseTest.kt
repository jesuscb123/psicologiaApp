...
class RegistrarFcmTokenActualUseCaseTest {

    @Test
    fun `invoke debe obtener token y registrarlo en el repositorio`() = runTest {
        ...
        val resultado = RegistrarFcmTokenActualUseCase(repo)()
