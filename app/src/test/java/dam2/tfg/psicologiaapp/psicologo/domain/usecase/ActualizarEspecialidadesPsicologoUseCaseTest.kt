...
class ActualizarEspecialidadesPsicologoUseCaseTest {
    ...
    fun `invoke debe propagar exito del repositorio`() = runTest {
        ...
        val repo = object : FakePsicologoRepository() {
            override suspend fun actualizarMisEspecialidades(especialidades: List<String>) = Result.success(expected)
        }
        val resultado = ActualizarEspecialidadesPsicologoUseCase(repo)(especialidades = listOf("Clinica"))
